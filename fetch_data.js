        ...
        if (data.response) {
            for (const item of data.response) {
                ...
                const matchData = {
                    ...
                    status: item.fixture.status.short, // 試合状況 (NS, FT など)
                    japaneseStats: []
                };
                ...
                // ★修正3：作成した試合データ（スタッツあり・なし両方）を配列に追加する
